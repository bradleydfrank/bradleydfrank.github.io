...
<figure class="my-6">
    ...
    <figcaption class="mt-2 text-sm">
        Top-down view of Janus droplets reacting to [a photo-chemical gradient due to uv light, while I was working on morphology resolved movement in 2021.](https://www.nature.com/articles/s41467-022-30229-3) Real time.  
    </figcaption>
</figure>